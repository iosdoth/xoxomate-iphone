...
- (void)viewDidLoad {
    ...
    self.users = [UsersDataSourceCall.instance usersWithIDS:self.session.opponentsIDs];
    [self confiugreGUI];
...
- (void)updateOfferInfo {
    ...
    QBUUser *caller = [UsersDataSourceCall.instance userWithID:[NSNumber numberWithInteger:[ServicesManager instance].currentUser.ID]];
